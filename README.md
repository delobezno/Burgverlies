...
Grid-Based Movement: 
  Precision movement system using a $16 \times 12$ raster grid.
Dynamic Guard AI: 
  Guards utilize a basic "chase" logic, recalculating the path to the player every 0.5 seconds.
State Management: 
  Fully implemented game states (Start, Playing, Win, Loss) with a restart mechanism.
Visual Polish: 
  Randomized floor textures and animations for smooth transitions between tiles.
